...
//		virtual FmiBoolean ReadRemaining(void){return kTrue;};  //290200 //pois 22.5.00
	...
	protected:
//		FmiBoolean ToLocalTime(NFmiPressTime& theTime) const;
        FmiBoolean PointParam(NFmiFastQueryInfo* theQI);
