/*---------------------------------------------------------------------------*/ 
//© Ilmatieteenlaitos/Lasse.               nprenvir.h 
// 
//Originaali 17.11.98 
// 
...
{ 
 public: 
	...
	void       SetLongNumberMinus(void) {fLongNumberMinus=kTrue;};
	void       SetShortNumberMinus(void) {fLongNumberMinus=kFalse;};
	...
	FmiBoolean IsRGB(void) const {return itsGenericColor.isRgb;};
	FmiBoolean IsCMYK(void) const {return !itsGenericColor.isRgb;};
	FmiGenericColor GetColor(void)const {return itsGenericColor;};
	FmiBoolean  GetLongNumberMinus(void)const {return fLongNumberMinus;};
