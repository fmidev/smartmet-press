...
//	virtual FmiBoolean IsEqual(const NFmiLocation & theLocation) const;
    int    ConvertDefText(NFmiString & object);

	virtual NFmiLocation* Clone(void) const; 
	NFmiString LocalWmoTime(int utc) const;     //23.10
	FmiBoolean LocalWmoTime(NFmiTime& utc) const; //28.1.00
	FmiBoolean LocalTime(NFmiTime& utc, int& errorCode) ; //2.3.00
