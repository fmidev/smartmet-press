...
//----------------------------------------------------------------------------
bool NFmiPressText::ReadDescription(NFmiString& retString) //16.1
{			 
	...
	*itsDescriptionFile >> itsObject;
	...
	switch(itsIntObject)
	{
			...
			{    
				if(itsLogFile)
					*itsLogFile << "*** ERROR: Tuntematon sana #Tekstiss‰: " << static_cast<char *>(itsObject) << endl;  
				ReadNext();
				break;
			}
			case dComment:	  
		...
		case dTextAlignment:
		{
			...
			*itsDescriptionFile >> itsObject;
			...
			if (lowChar == NFmiString ("center") || lowChar == NFmiString ("keskipiste")
				...
				*itsLogFile << "*** ERROR: Tuntematon kohdistus tekstiss‰: " << static_cast<char *>(itsObject) << endl;  
...
/*
// 9.10.98----------------------------------------------------------------------------
bool NFmiPressText::IsPureBlack(void)
{
