...
//----------------------------------------------------------------------------
FmiBoolean NFmiPressSameSymbols::ReadDescription(NFmiString& retString) //16.1
{
	// FmiBoolean hasOwnData = isFalse; 
	FmiBoolean helpBool;
...
//	NFmiStationPoint newStation;
	...
	switch(iobject)
	{
		...
		case dPlaceSymbol:     
		{
			...
			// FmiBoolean ok = itsPsSymbol.ReadDescription(string);
...
//----------------------------------------------------------------------------
FmiBoolean NFmiPressSameSymbols::WritePS(ofstream& theOutFile)
{
