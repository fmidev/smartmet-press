...
//----------------------------------------------------------------------------
FmiBoolean NFmiPressImage::ReadDescription(NFmiString& retString) 
{			 
...
//---------------------------------------------------------------------------
FmiBoolean	NFmiPressImage::WritePS(FmiPressOutputMode theOutput)																					
{
    ScalePlotting();
