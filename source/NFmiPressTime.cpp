...
//	  if(str1 == NFmiString(kFmiDirectorySeparator))  //myˆs formaatille varatut merkit saadaan kun laitetaan ne kenojen v‰liin
// Mikan korjaus ei k‰y koska ei kyse polusta
	  if(str1 == NFmiString("\\"))  //myˆs formaatille varatut merkit saadaan kun laitetaan ne kenojen v‰liin
	  {
...
const char 
    *reldays [] = 
	{"alivuoto","Toissap‰iv‰n‰", "Eilen", "T‰n‰‰n", "Huomenna", "Ylihuomenna", "ylivuoto", 
	  ...
	  "alivuoto","I fˆrrgÂr", "I gÂr", "I dag", "I morgon", "I ˆvermorgon","ylivuoto", 
