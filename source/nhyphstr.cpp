...
//---------------------------------------------------------------
FmiBoolean NFmiHyphenationString::NextIsNumeric(void)
{
	NextPosition();
...
//---------------------------------------------------------------
FmiBoolean NFmiHyphenationString::NextChar(const NFmiString &theChar)
{
	while(NextPosition())
	{
...
//---------------------------------------------------------------
FmiBoolean NFmiHyphenationString::NextConsonant(void)
{
	while(NextPosition())
	{
...
//---------------------------------------------------------------
FmiBoolean NFmiHyphenationString::BackPosition(void)
{
...
//---------------------------------------------------------------
FmiBoolean NFmiHyphenationString::NextPosition(void)
{
...
//---------------------------------------------------------------
FmiBoolean NFmiHyphenationString::IsConsonant(const NFmiString &theChar) const
{
...
//---------------------------------------------------------------
FmiBoolean NFmiHyphenationString::IsNumeric(const NFmiString &theChar) const
{
...
//---------------------------------------------------------------
FmiBoolean NFmiHyphenationString::IsVowel(const NFmiString &theChar) const
{
...
//---------------------------------------------------------------
FmiBoolean NFmiHyphenationString::IsLastCharPosition(void) const
{
	return itsCurrentCharPos >= GetLen();
}
//---------------------------------------------------------------
FmiBoolean NFmiHyphenationString :: NextSubString (const NFmiString &toDelimiter, NFmiString& resString) // 5.10.1999/Lasse
{
...
//---------------------------------------------------------------
FmiBoolean NFmiHyphenationString :: NextSubString (NFmiString& resString) // 19.10.1999/Lasse
