...
//----------------------------------------------------------------------------
//----------------------------------------------------------------------------
FmiBoolean NFmiTimeParamRect::ReadDescription(NFmiString& retString) 
{			 
...
//---------------------------------------------------------------------------
FmiBoolean	NFmiTimeParamRect::WritePS( const NFmiRect & AbsoluteRectOfSymbolGroup
...
//---------------------------------------------------------------------------
//1.3.00 
FmiBoolean NFmiTimeParamRect::ToLocalTime(NFmiPressTime& theTime) const
...
//		NFmiStationPoint statPoint(location,NFmiPoint(0.,0.));
	...
	else
	{
		 ...
		 theTime = localTime;
		 return kTrue; //entäs jos longitudi puuttuu
	}
...
//-050399---------------------------------------------------------------------------
FmiBoolean NFmiTimeParamRect:: PointParam(NFmiFastQueryInfo* theQI)
