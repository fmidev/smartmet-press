...
//----------------------------------------------------------------------------
FmiBoolean NFmiSymbolParamRect::ReadDescription(NFmiString& retString) 
{										 
...
//----------------------------------------------------------------------------
FmiBoolean NFmiSymbolParamRect::ReadRemaining(void)  //161000
{
...
/*
//181000----------------------------------------------------------------------------
FmiBoolean NFmiSymbolParamRect::ReadSymbolScale(FmiValueScaling& theScale) //20.10.00
{
...
//----------------------------------------------------------------------------
FmiBoolean NFmiSymbolParamRect::CopyShortSymbol2Dest(NFmiString* symbolFile, ofstream& theDestinationFile)
{//10.2
        ...
        {
		   FmiBoolean tempBool = NFmiWritePSConcat(itsDefToProductScale, theDestinationFile);
...
//----------------------------------------------------------------------------
FmiBoolean NFmiSymbolParamRect::ConvertOrig2Short(NFmiString* symbolFile)
{ //10.2
// VAIN WINDOWSILLA TEHDYILLE SYMBOLEILLE
   ...
   char inBuf[lineSize];
   FmiBoolean copyOn = kFalse;  
//   FmiBoolean isWindows = isFalse;  //11.2 oltava Windows
...
//----------------------------------------------------------------------------
FmiBoolean NFmiSymbolParamRect::WritePS( const NFmiRect & AbsoluteRectOfSymbolGroup
										...
										,FmiPressOutputMode theOutput)
{
   ...
   else
   {
	...
	//			 (theQI); //1.2.2000	
			...
			isScaled = kFalse;         //skaalaus vielä poissa
		}
		else 
...
//----------------------------------------------------------------------------
FmiBoolean NFmiSymbolParamRect::ReadValues( NFmiFastQueryInfo* theQI, bool setRelHour)
{
