...
/*
//---------------------------------------------------------------------------
FmiBoolean NFmiRotatingParamRect::Set(NFmiDataIdent theParam, NFmiRect theRect)
{
	itsRotatingDataIdent = theParam; //080199 lisä tälle luokalle 
	return NFmi2SymbolParamRect :: Set(theParam, theRect);
	*/
//----------------------------------------------------------------------------
FmiBoolean NFmiRotatingParamRect::ReadRemaining(void)  //171198
{
//	long long1;
...
//----------------------------------------------------------------------------
FmiBoolean NFmiRotatingParamRect::CopyShortSymbol2Dest(NFmiString* symbolFile, ofstream& theDestinationFile)
{//11.2
...
/*	return itsVerticalLong < kFloatMissing ?
		 ...
		 */
//----------------------------------------------------------------------------
FmiBoolean NFmiRotatingParamRect::Rotate(void) const
{//241198
...
FmiBoolean NFmiRotatingParamRect:: PointOnSecondParam(NFmiQueryInfo* theQI)
{
...
/*
//----------------------------------------------------------------------------
FmiBoolean NFmiRotatingParamRect::ReadValues( NFmiQueryInfo* theQI)
{
