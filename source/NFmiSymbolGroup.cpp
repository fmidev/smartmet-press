...
int NFmiSymbolGroup::ConvertDefText(NFmiString &object)
{
  ...
  if (lowChar == NFmiString("size") || lowChar == NFmiString("koko"))
    ...
    return dSymbol;
           ...
           lowChar == NFmiString("#kiinteäsymboli") || lowChar == NFmiString("#vakiosymboli") ||
  ...
  else if (lowChar == NFmiString("#extremeplace") || lowChar == NFmiString("#ääriarvopaikka"))
    ...
    return dSunTime;
           ...
           lowChar == NFmiString("#kääntyväsymboli") || lowChar == NFmiString("#kääntyväkuva"))
    return dRotating;
