...
//----------------------------------------------------------------------------
//----------------------------------------------------------------------------
FmiBoolean NFmiLetterParamRect::ReadDescription(NFmiString& retString) 
{			 
...
//---------------------------------------------------------------------------
FmiBoolean	NFmiLetterParamRect::WritePS( const NFmiRect & AbsoluteRectOfSymbolGroup
...
//			isScaled = kFalse;         //onko tässä ollut niinkuin symbolissa
		}
		else 
