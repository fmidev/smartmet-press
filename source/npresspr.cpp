...
extern FmiBoolean NFmiCopyFile(ifstream&, ofstream&);
extern FmiBoolean NFmiCopyFileWithoutShowpage(ifstream&, ofstream&);
extern FmiBoolean NFmiCopyFileColoring(ifstream&, ofstream&, NFmiCmykColorBag*);
extern FmiBoolean NFmiCopyFileCropping(ifstream&, ofstream&,NFmiRect);  //15.5
extern FmiBoolean NFmiCopyFileCroppingAndColoring(ifstream&, ofstream&,NFmiRect,NFmiCmykColorBag*);//16.6
extern FmiBoolean NFmiWritePSConcat(NFmiRectScale, ofstream&);
extern FmiBoolean NFmiWritePSEnd(ofstream&);
extern FmiBoolean NFmiWriteEPSConcat(NFmiRectScale, ofstream&);
extern FmiBoolean NFmiWriteEPSConcatClipping(NFmiRectScale, ofstream&, NFmiRect);
extern FmiBoolean NFmiWriteEPSEnd(ofstream&);
extern FmiBoolean NFmiWriteBoundingBox(ofstream& outFile, NFmiRect theRect); //23.11.01
...
NFmiPressProduct :: ~NFmiPressProduct (void) 
{
	...
	itsParams.Clear(kTrue);
	itsSameSymbols.Clear(kTrue); 
	itsEpsFileNames.Clear(kTrue); 
	itsDatas.Clear(kTrue);       
	if(itsLogFile)               
		delete itsLogFile;
	if(itsPalette)
		delete itsPalette;
...
//20.3.00----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::SetLogFile(FmiBoolean OnOff)
...
//20.3.00----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::SetProductName(const NFmiString& theName)
{
	itsOutFileName = theName;
	fTimeStamp = kFalse;
	fDataTimeStamp = kFalse;
	itsProductNameFormat = NFmiString(); //nollaus

	return kTrue;
}; 
//15.1.01----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::SetProductNameFormat(const NFmiString& theName)
{
...
//7.9.01----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::SetMaskNumber(unsigned long theNumber)
{
	FmiBoolean retCode = false;
...
//			retCode = kTrue; //ainakin yhdessä vaihdettu
...
//22.3.00----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::SetSegmentData(const NFmiString& theDataName)
{
	FmiBoolean retCode = false;
	NFmiVoidPtrIterator paramIter = NFmiVoidPtrIterator(itsParams);
	NFmiPressParam *param;
...
//30.11.00----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::SetFirstObjectActivity(bool theActivity)   
{
...
//17.3.00----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::SetFirstStation(const NFmiLocation& theLocation)   
{
	FmiBoolean retCode = false;
	NFmiVoidPtrIterator paramIter = NFmiVoidPtrIterator(itsParams);
	NFmiPressParam *param;
...
//29.9.00----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::SetImagePreNames(const NFmiLocation& theLocation)   
{
	FmiBoolean retCode = kFalse;   
	NFmiVoidPtrIterator objectIter = NFmiVoidPtrIterator(itsObjects);
...
//7.6.00----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::SetStationRename(const NFmiRenaming& theRename)   
{
	FmiBoolean retCode = false;
	NFmiVoidPtrIterator paramIter = NFmiVoidPtrIterator(itsParams);
	NFmiPressParam *param;
...
//17.3.00----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::SetAllTimes(const NFmiMetTime& theTime)   
{
...
//17.3.00----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::SetAllLanguages(FmiLanguage theLanguage)   
{
	itsLanguage = theLanguage; //oma ensi

	FmiBoolean retCode=kTrue;//HUOM
...
//11.8.99----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::ReadNameToLonLatList()
{
...
//----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::PreProcessDefinition(const string& inFileName, const string& outFileName)
...
//----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::PreProcessProduct( ifstream& inFile, ofstream& outFile)
{
...
//-----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::DefinePar(const NFmiString& theString)  
{
...
//-080399----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::ReplacePar(NFmiString& theString)  
{
	return kTrue;
}
//----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::ReadDescriptionFile(NFmiString inputFile) 
{  
...
//050199----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::ReadData()
{
   if (fDataRead)   
	   return kTrue;
...
//       string += NFmiString("\\Data");
   ...
   FmiBoolean secondDir = kFalse;
   FmiBoolean twoOptinalTypes = kTrue; //6.8.01
...
FmiBoolean NFmiPressProduct::ReadQueryData(NFmiQueryData *theQD,char *fileName)
{
...
//12.12 katkaistu----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::ReadDescription(NFmiString& retString) //16.1
{
	...
	itsNumberOfMaps = 1;
	fMapIsEps = kTrue;
	fTimeStamp = kFalse;  //16.3.00
	fDataTimeStamp = kFalse; //16.3.00
	itsLanguage = kFinnish;
...
//			itsArea.SetXyRequest(kTrue); //18.5.01 tuotetasolla ei tiedetä onko alueoperaatioihin     
...
//----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::WritePS(FmiPressOutputMode theGivenOutput) 
{
   itsNumOfWritePS++;  
...
//----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::Close() 
{
	if(itsLogFile)
	{
...
//----------------------------------------------------------------------------
FmiBoolean NFmiPressProduct::ConstructOutFileName() 
{
	char* hChar;
	NFmiString string;  
