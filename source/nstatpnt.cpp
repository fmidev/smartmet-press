...
/* 
//----------------------------------------------------------------------------
FmiBoolean NFmiStationPoint::IsEqual(const NFmiLocation & theLocation) const
...
//----------------------------------------------------------------------------
FmiBoolean NFmiStationPoint::ReadDescription(NFmiString& retString) //16.1
{
	NFmiString string;
	NFmiString name;
	char object[255], ch;
...
//---------------------------------------------------------------------------------------
FmiBoolean NFmiStationPoint:: LocalTime(NFmiTime& utc, int& errorCode) //const
...
//---------------------------------------------------------------------------------------
FmiBoolean NFmiStationPoint:: LocalWmoTime(NFmiTime& utc) const
{     
...
float NFmiStationPoint::GetWmoDifference(void) const
{
	...
	FmiBoolean useSummerTime = kTrue;
	...
	{
	  zoneDifferenceHour = 2;
//	  useSummerTime = kFalse; //17.3.2000, ensi kes‰n‰ baltia ei en‰‰ kes‰ajassa; 11.4.2002 taas kes‰ajassa
	}	  
	else if( wmoCode == 26629)//Tallinna,Riika,Vilna?
	{
	  zoneDifferenceHour = 2;
	  useSummerTime = kFalse;    //17.3.2000, ensi kes‰n‰ baltia ei en‰‰ kes‰ajassa ENTƒ 2002??
	}	  
