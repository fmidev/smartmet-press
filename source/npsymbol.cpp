...
/*
//---------------------------------------------------------------------------
FmiBoolean NFmiPsSymbol::Set( NFmiRectScale &theScale
...
*/
//----------------------------------------------------------------------------
FmiBoolean NFmiPsSymbol::CopyShortSymbol2Dest(void)//const NFmiString& symbolFile)
{//10.2
...
//		fileName += SymbolSetName();
        ...
        if(itsInFile->good() && !itsInFile->eof())  
        {
		   FmiBoolean tempBool = WritePSConcat();
		   tempBool = CopyFile();
		   tempBool = WritePSEnd();
           // itsInFile.close();
           // itsInFile.clear();
...
//----------------------------------------------------------------------------
FmiBoolean NFmiPsSymbol::ConvertOrig2Short(void)//const NFmiString& symbolFile) 
{ //10.2
...
//----------------------------------------------------------------------------
FmiBoolean NFmiPsSymbol::ReadDescription(NFmiString& retString)
{										 
...
//----------------------------------------------------------------------------
FmiBoolean NFmiPsSymbol::MakeAndWritePS(NFmiPoint place)
{
	Place(place);
	ScalePlotting();
...
//----------------------------------------------------------------------------
FmiBoolean NFmiPsSymbol::WritePS(FmiPressOutputMode theOutput) //15.3.00
{
//	Place(place);
	ScalePlotting();
	if (CopyShortSymbol2Dest()) //itsSymbol
