...
//7.6.00---------------------------------------------------------------------------
FmiBoolean NFmiPressStationText::SetNewName(const NFmiRenaming& theRename)//7.6.00
...
//---------------------------------------------------------------------------
FmiBoolean	NFmiPressStationText::WritePS(FmiPressOutputMode theOutput)									
{
	if(!itsData)    //4.9
		return isFalse;
