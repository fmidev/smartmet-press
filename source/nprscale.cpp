...
//---------------------------------------------------------------------------
FmiBoolean NFmiPressScaling::Set( NFmiRectScale &theScale
...
//---------------------------------------------------------------------------
FmiBoolean NFmiPressScaling::SetScale(const NFmiRectScale &theScale)	
{
	itsRectScale = theScale;	
	return kTrue;
};
//261198----------------------------------------------------------------------------
FmiBoolean NFmiPressScaling::ReadRemaining(void)  
{
	double r1, r2, r3;
...
//----------------------------------------------------------------------------
FmiBoolean NFmiPressScaling::	WritePS(const NFmiPoint& place, FmiPressOutputMode theOutput)
{ 
	itsPlace = place;
