...
//----------------------------------------------------------------------------
FmiBoolean NFmiNumberParamRect::ReadDescription(NFmiString& retString) 
{	
	long long1;                
	double r1,r2,r3,r4;
...
//171198----------------------------------------------------------------------------
FmiBoolean NFmiNumberParamRect::ReadRemaining(void)  
{
/*
	switch(itsIntObject)
	{	
...
//---------------------------------------------------------------------------
FmiBoolean NFmiNumberParamRect::WritePS( const NFmiRect & AbsoluteRectOfSymbolGroup
